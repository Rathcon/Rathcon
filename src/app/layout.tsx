...
export const metadata: Metadata = {
  title: {
    default: 'Rathcon Construction - Leading Construction Company in Mumbai & Thane',
    template: '%s | Rathcon Construction'
  },
  description: 'Rathcon Construction is a leading construction company in Mumbai and Thane, specializing in residential construction, commercial projects, interior design, renovations, and civil works. Get free quotes for your construction projects.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Rathcon Construction is a leading construction company in Mumbai and Thane, specializing in residential construction, commercial projects, interior design, renovations, and civil works.',
    images: [
      {
        url: '/logo.png',
        width: 1200,
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Leading construction company in Mumbai and Thane, specializing in residential construction, commercial projects, interior design, renovations, and civil works.",
              "url": "https://www.rathconconstruction.com",
